...
/**
 * 用来加载类，classpath下的资源文件，属性文件等。 getExtendResource(String relativePath)方法，可以使用..
 * / 符号来加载classpath外部的资源。
 */
public class ClassLoaderUtil {
	...
	/**
	 * Thread.currentThread().getContextClassLoader().getResource("") 加载Java类。
	 * 使用全限定类名
	 * @paramclassName
	 * @return
	 */
	...
	/**
	 * @paramrelativePath 
	 *                    必须传递资源的相对路径。是相对于classpath的路径。如果需要查找classpath外部的资源，需要使用.
	 *                    ./来查找
	 * @return资源的绝对URL
	 * @throwsMalformedURLException
	 */
