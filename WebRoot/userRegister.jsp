...
<script type="text/javascript" src="style/js/signinYanzheng.js"></script>
</head>
<body onLoad="createCode();">
	<div class="clearfix" id="signin-header">
	...
	<div id="signin" type="signin-form">
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<form class="form-horizontal" action="registerPro" method="post">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="password" name="password" class="form-control"
									id="pass1" onblur="check();enablebtn();"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="password" class="form-control" id="pass2"
									onblur="check2();enablebtn();" placeholder="密码长度为6~20位">
								<span id="text3"></span>
							</div>
							<a id="pawd2"></a>
						</div>
					...
					<div class="col-md-8 col-md-offset-3" style="padding-left:0px;">
						<button class="btn btn-lg btn-success btn-block" id="btnSubmit"
							disabled="true" type="submit">注 册</button>
